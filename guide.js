    ...
    },
    {
      ...
      items: [
        { img: "screens/host/team.png", title: "أزرار الفرق",
          desc: "تعرض الفرق وتمكّنك من إدارتها تغيير اسمها و إضافة النقاط." },
        { img: "screens/host/deleteTeam.png", title: "حذف فريق",
          desc: "لإزالة فريق من الجلسة." },
        { img: "screens/host/time.png", title: "وقت الإجابة",
          desc: "لضبط مدة اللاعب  للاجابة." },
        { img: "screens/host/cooldownTime.png", title: "وقت منع الضغط",
          desc: "وضع مدة لمنع اللاعب من الضفط ( ايقاف يمكن اللاعب الضغط بعد انتهاء وقته )" },
        { img: "screens/host/openForAll.png", title: "مفتوح للجميع",
          desc: "يفتح الازرار حتى لو وجد وقت للمنع." },
        { img: "screens/host/deleteWinner.png", title: "مسح الفائز",
          desc: "حذف الفائز من شاشة المشرف." },
        { img: "screens/host/closeBtn.png", title: "قفل الازرار",
          desc: "قفل الأزرار قبل او اثناء اللعب ومنع اللاعب من الضغط." },
      ],
    },
    {
      id: "player",
      ...
      items: [
        { img: "screens/player/answerTime.png", title: "وقت الإجابة",
          desc: "العداد الذي يخبر اللاعب ان يجيب قبل ان ينتهي." },
        { img: "screens/player/cooldownTimer.png", title: "وقت المنع",
          desc: "الفترة التي يُمنع فيها الضغط." },
        ...
        { img: "screens/player/Buzz.png", title: "زر الضغط الكبير",
          desc: "الزر الذي يسمح لك عند ضفطه بالجواب." },
      ],
    },
  ];
